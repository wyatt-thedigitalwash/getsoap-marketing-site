...
function PortfolioDashboardVisual() {
  return (
    <div
      className="h-[200px] overflow-hidden rounded-xl p-5 md:h-[240px]"
    ...
    >
      ...
      <div className="bg-white px-3 py-2" style={{ border: "1px solid #E8EAED", borderTop: "none", borderRadius: "0 0 8px 8px" }}>
        ...
        <div className="border-b py-2" style={{ borderColor: "#E8EAED" }}>
          ...
          <div className="mt-0.5 flex items-center gap-1">
            <Stars count={5} size={10} />
            <span className="text-[9px]" style={{ color: "#71717A" }}>4.9 (47)</span>
          </div>
        ...
        <div className="border-b py-2 opacity-50" style={{ borderColor: "#E8EAED" }}>
          ...
          <div className="mt-0.5 flex items-center gap-1">
            <Stars count={4} size={9} />
            <span className="text-[9px]" style={{ color: "#71717A" }}>4.2 (23)</span>
          </div>
        ...
        <div className="py-2 opacity-50">
          ...
          <div className="mt-0.5 flex items-center gap-1">
            <Stars count={4} size={9} />
            <span className="text-[9px]" style={{ color: "#71717A" }}>3.8 (12)</span>
          </div>
...
const cards = [
  {
    ...
    description:
      "Every brand and location in one view. Performance metrics, lead tracking, and reporting rolled up for corporate and broken out for each franchisee.",
  ...
  },
  {
    ...
    description:
      "Every franchisee gets a branded, SEO-optimized website for their location. Built on Soap's infrastructure, managed through the platform, compliant with brand standards.",
  ...
  },
  {
    ...
    description:
      "Automated audits, content production, citation management, schema deployment, and local rank tracking built into every location from day one.",
  ...
  },
  {
    ...
    description:
      "Automated audits, post scheduling, review requests, review response drafting, and photo management across hundreds of locations.",
...
export default function HowItWorksCards() {
  ...
  return (
    <div
      ref={gridRef}
      className="mx-auto mt-14 grid max-w-7xl grid-cols-1 items-stretch gap-6 md:grid-cols-2"
    >
      {cards.map((card, i) => (
        <div
          key={card.title}
        ...
        >
          ...
          <p
            className="mt-2.5 flex-1 text-[15px] leading-[1.6] md:text-[16px]"
            style={{ color: "#1F1F1F" }}
          >
            {card.description}
          </p>
