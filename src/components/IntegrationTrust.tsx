...
export default function IntegrationTrust() {
  return (
    <section data-bg="white" className="px-6 pt-0 pb-[84px] md:px-16 md:pt-0 md:pb-[112px]">
      <div className="mx-auto max-w-7xl">
        <ScrollReveal>
          ...
          <p
            className="mx-auto mt-4 max-w-[600px] text-center text-[16px] leading-[1.6] md:text-[17px]"
            style={{ color: "#1F1F1F" }}
          >
