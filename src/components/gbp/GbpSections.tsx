...
function CheckList({ items, iconColor = "#1A5799", textColor = "#1F1F1F", textSize = "15px" }: { items: string[]; iconColor?: string; textColor?: string; textSize?: string }) {
  return (
      ...
      <Container className="relative">
        <ScrollReveal>
          <div className="text-center">
            <p className="text-[11px] font-bold uppercase tracking-[0.12em]" style={{ color: "#1A5799" }}>Why It Matters</p>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
          {whyStats.map((s, i) => (
            <ScrollReveal key={s.value} delay={150 + i * 100} distance={24} premium className="rounded-xl bg-white" style={{ border: "1px solid #E2E8F0", padding: 28 }}>
              <p className="text-[44px] font-extrabold leading-none" style={{ color: "#1A5799" }}>{s.value}</p>
              <p className="mt-3 text-[13px] font-semibold uppercase tracking-[0.08em]" style={{ color: "#092F64" }}>{s.label}</p>
      ...
      <Container>
        <ScrollReveal>
          <div className="mb-12 text-center md:mb-16">
            <p className="text-[11px] font-bold uppercase tracking-[0.12em]" style={{ color: "#1A5799" }}>Managed Capabilities</p>
            <h2 className="mx-auto mt-4 max-w-[760px] text-[32px] font-extrabold leading-[1.1] tracking-[-0.02em] md:text-[44px]" style={{ color: "#092F64" }}>Every profile, professionally managed.</h2>
          </div>
        </ScrollReveal>
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          <ScrollReveal threshold={0.1} distance={48} duration={800} premium>
            <div
              ...
              style={{ border: "1px solid #E2E8F0", boxShadow: "0 4px 20px rgba(9, 47, 100, 0.05)" }}
            >
              <div className="md:hidden">
                ...
                <div className="pt-6">
                  <h2 className="text-[26px] font-extrabold leading-tight tracking-[-0.02em]" style={{ color: "#092F64" }}>Continuous GBP audits.</h2>
                  <p className="mt-3 text-[15px] font-medium leading-[1.5] md:text-[16px]" style={{ color: "#468BE6" }}>Issues surfaced before they hurt rankings.</p>
              ...
              <div className="hidden md:grid" style={{ gridTemplateColumns: "1fr 1fr", gap: 48, padding: "24px 24px", alignItems: "center" }}>
                <div className="flex flex-col justify-center">
                  <h2 className="text-[26px] font-extrabold leading-tight tracking-[-0.02em] md:text-[32px]" style={{ color: "#092F64" }}>Continuous GBP audits.</h2>
                  <p className="mt-3 text-[15px] font-medium leading-[1.5] md:text-[16px]" style={{ color: "#468BE6" }}>Issues surfaced before they hurt rankings.</p>
                  <CheckList items={auditFeatures} />
                </div>
          ...
          <ScrollReveal threshold={0.1} distance={48} duration={800} premium>
            ...
            >
              <div className="md:hidden">
                ...
                <div className="pt-6">
                  <h2 className="text-[26px] font-extrabold leading-tight tracking-[-0.02em]" style={{ color: "#092F64" }}>Automated GBP posting.</h2>
                  <p className="mt-3 text-[15px] font-medium leading-[1.5] md:text-[16px]" style={{ color: "#468BE6" }}>Brand-aligned content scheduled across every location.</p>
              ...
              <div className="hidden md:grid" style={{ gridTemplateColumns: "1fr 1fr", gap: 48, padding: "24px 24px", alignItems: "center" }}>
                ...
                <div className="flex flex-col justify-center order-2">
                  <h2 className="text-[26px] font-extrabold leading-tight tracking-[-0.02em] md:text-[32px]" style={{ color: "#092F64" }}>Automated GBP posting.</h2>
                  <p className="mt-3 text-[15px] font-medium leading-[1.5] md:text-[16px]" style={{ color: "#468BE6" }}>Brand-aligned content scheduled across every location.</p>
                  <CheckList items={postingFeatures} />
                </div>
              </div>
          ...
          <ScrollReveal threshold={0.1} distance={48} duration={800} premium>
            ...
            >
              <div className="md:hidden">
                ...
                <div className="pt-6">
                  <h2 className="text-[26px] font-extrabold leading-tight tracking-[-0.02em]" style={{ color: "#092F64" }}>Photo management at scale.</h2>
                  <p className="mt-3 text-[15px] font-medium leading-[1.5] md:text-[16px]" style={{ color: "#468BE6" }}>Fresh photos uploaded continuously across every franchisee profile.</p>
                  <CheckList items={photoFeatures} />
                </div>
              </div>
              <div className="hidden md:grid" style={{ gridTemplateColumns: "1fr 1fr", gap: 48, padding: "24px 24px", alignItems: "center" }}>
                <div className="flex flex-col justify-center">
                  <h2 className="text-[26px] font-extrabold leading-tight tracking-[-0.02em] md:text-[32px]" style={{ color: "#092F64" }}>Photo management at scale.</h2>
                  <p className="mt-3 text-[15px] font-medium leading-[1.5] md:text-[16px]" style={{ color: "#468BE6" }}>Fresh photos uploaded continuously across every franchisee profile.</p>
                  <CheckList items={photoFeatures} />
                </div>
                <div className="rounded-[14px] flex flex-col p-5" style={{ backgroundColor: "#F1F5F9", border: "1px solid #E2E8F0" }}>
  ...
  return (
    <section data-bg="light" className="relative px-6 py-[84px] md:px-16 md:py-[112px]" style={{ backgroundColor: "#E9F5FF" }}>
      ...
      <Container className="relative">
        <ScrollReveal>
          <div className="text-center">
            <p className="text-[11px] font-bold uppercase tracking-[0.12em]" style={{ color: "#1A5799" }}>Reviews</p>
            <h2 className="mx-auto mt-4 max-w-[760px] text-[34px] font-extrabold leading-tight tracking-[-0.02em] md:text-[46px]" style={{ color: "#092F64" }}>
