  ...
  return (
    <div className="mx-auto flex w-full max-w-[360px] flex-col items-stretch">
      ...
      <div className={box} style={boxStyle}>
        <p className={`${mono} text-[16px] font-bold`} style={{ color: "#092F64" }}>bumbleroofing.com</p>
      ...
      {/* Box 2: /locations */}
      <div className={box} style={boxStyle}>
        <p className={`${mono} text-[14px] font-semibold`} style={{ color: "#092F64" }}>/locations</p>
      ...
      <div className={box} style={boxStyle}>
        <p className={`${mono} text-[14px] font-semibold`} style={{ color: "#092F64" }}>/locations/tampa</p>
      ...
      <div className="flex gap-2">
        ...
        <div className="flex-1 rounded-lg bg-white" style={{ border: "1px solid #E1E5EC", padding: 12 }}>
          ...
          <div className="flex flex-col gap-1">
            <p className={`${mono} text-[11px]`} style={{ color: "#092F64" }}>/services/storm-damage-restoration</p>
            <p className={`${mono} text-[11px]`} style={{ color: "#092F64" }}>/services/roof-replacement</p>
            <p className={`${mono} text-[11px]`} style={{ color: "#092F64" }}>/services/roof-repair</p>
            <p className={`${mono} text-[11px]`} style={{ color: "#092F64" }}>/services/commercial-roofing</p>
          </div>
        </div>
        {/* Areas */}
        <div className="flex-1 rounded-lg bg-white" style={{ border: "1px solid #E1E5EC", padding: 12 }}>
          ...
          <div className="flex flex-col gap-1">
            <p className={`${mono} text-[11px]`} style={{ color: "#092F64" }}>/areas/downtown</p>
            <p className={`${mono} text-[11px]`} style={{ color: "#092F64" }}>/areas/brandon</p>
            <p className={`${mono} text-[11px]`} style={{ color: "#092F64" }}>/areas/wesley-chapel</p>
            <p className={`${mono} text-[11px]`} style={{ color: "#092F64" }}>/areas/riverview</p>
          </div>
        </div>
      </div>
