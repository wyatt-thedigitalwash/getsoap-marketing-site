    ...
    <div className="mx-auto" style={{ width: 280 }}>
      ...
      >
        <div className="overflow-hidden bg-white" style={{ borderRadius: 24 }}>
          ...
          >
            <span className="text-[11px] font-medium" style={{ color: "#092F64" }}>9:41</span>
          ...
          <div style={{ padding: "12px 16px", borderBottom: "1px solid #E2E8F0" }}>
            <p className="text-[16px] font-bold" style={{ color: "#092F64" }}>Tampa Location</p>
          </div>
          ...
          <div className="flex flex-col gap-2.5" style={{ padding: "12px 16px" }}>
            {[
              ...
              >
                <span className="text-[13px] font-medium" style={{ color: "#092F64" }}>{stat.label}</span>
                {stat.up ? (
          ...
          <div style={{ padding: "8px 16px 20px" }}>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-start gap-2 rounded-lg" style={{ padding: "8px 10px", border: "1px solid #E2E8F0" }}>
                <div className="mt-0.5 h-2 w-2 shrink-0 rounded-full" style={{ backgroundColor: "#468BE6" }} />
                <p className="text-[11px]" style={{ color: "#092F64" }}>New lead: Sarah K. from Google</p>
              </div>
              <div className="flex items-start gap-2 rounded-lg" style={{ padding: "8px 10px", border: "1px solid #E2E8F0" }}>
                <div className="mt-0.5 h-2 w-2 shrink-0 rounded-full" style={{ backgroundColor: "#FBBC04" }} />
                <p className="text-[11px]" style={{ color: "#092F64" }}>New review from David M.</p>
              </div>
            </div>
          </div>
        </div>
